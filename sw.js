const VERSION = 'ldc-v2.19.51-R1B';
const CACHE_PREFIX = 'ldc-le-livre-du-ciel-';
const SHELL_CACHE = `${CACHE_PREFIX}shell-v2.19.51-R1B`;
const RUNTIME_CACHE = `${CACHE_PREFIX}runtime-v2.19.51-R1B`;
const OFFLINE_CACHE = 'ldc-le-livre-du-ciel-offline-v2.19.51-R1B';
const OFFLINE_MANIFEST_URL = './offline_manifest.json';
const OFFLINE_MANIFEST_SCHEMA = 'ldc-offline-manifest-v2';
const OFFLINE_CONTENT_BINDING = 'abfcfa0b8086ba90922e189bc415143761377bbfd69c2e5229397437db81d303';
const OFFLINE_CORPUS_MANIFEST_SHA256 = '41d21d868ccdca3ea6b4cf6371542133ab35d6a9d3f58f8dc941d8b9e8234056';
...
async function loadOfflineManifest() {
  ...
  if(m.schema!==OFFLINE_MANIFEST_SCHEMA||m.app_version!=='v2.19.51-R1B'||m.cache_version!==OFFLINE_CACHE)throw new Error('offline manifest incompatible');
