const VERSION = 'ldc-v2.19.95-R1B-semantic-scaling-r4-closure-r1';
...
const SHELL_CACHE = `${SCOPE_CACHE_PREFIX}shell-v2.19.95-R1B-semantic-scaling-r4-closure-r1`;
const RUNTIME_CACHE = `${SCOPE_CACHE_PREFIX}runtime-v2.19.95-R1B-semantic-scaling-r4-closure-r1`;
...
async function loadOfflineManifest() {
  ...
  if(m.schema!==OFFLINE_MANIFEST_SCHEMA||m.app_version!=='v2.19.95-R1B'||m.storage_schema!==OFFLINE_STORAGE_SCHEMA)throw new Error('offline manifest incompatible');
