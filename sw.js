const VERSION = 'ldc-v2.19.52-R1B';
const CACHE_PREFIX = 'ldc-le-livre-du-ciel-';
const SHELL_CACHE = `${CACHE_PREFIX}shell-v2.19.52-R1B`;
const RUNTIME_CACHE = `${CACHE_PREFIX}runtime-v2.19.52-R1B`;
const OFFLINE_CACHE = 'ldc-le-livre-du-ciel-offline-v2.19.52-R1B';
const OFFLINE_MANIFEST_URL = './offline_manifest.json';
const OFFLINE_MANIFEST_SCHEMA = 'ldc-offline-manifest-v2';
const OFFLINE_CONTENT_BINDING = 'ab447e7372d3708b964fbc05f6aebb223a72a4474e4853661b6c943fbece7a71';
const OFFLINE_CORPUS_MANIFEST_SHA256 = '85cb8b0b8095f47583fef851f7305d6819be7f3e6ee12b5c7212ca90c94062fc';
...
async function loadOfflineManifest() {
  ...
  if(m.schema!==OFFLINE_MANIFEST_SCHEMA||m.app_version!=='v2.19.52-R1B'||m.cache_version!==OFFLINE_CACHE)throw new Error('offline manifest incompatible');
