const VERSION = 'ldc-v2.19.91-R1B-stage14-search-v22-a9-near-r1';
...
const SHELL_CACHE = `${SCOPE_CACHE_PREFIX}shell-v2.19.91-R1B-stage14-search-v22-a9-near-r1`;
const RUNTIME_CACHE = `${SCOPE_CACHE_PREFIX}runtime-v2.19.91-R1B-stage14-search-v22-a9-near-r1`;
...
async function loadOfflineManifest() {
  ...
  if(m.schema!==OFFLINE_MANIFEST_SCHEMA||m.app_version!=='v2.19.91-R1B'||m.storage_schema!==OFFLINE_STORAGE_SCHEMA)throw new Error('offline manifest incompatible');
