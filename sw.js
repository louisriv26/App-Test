const VERSION = 'ldc-v2.19.116-R1B-nav-diagnostic-r1';
...
const SHELL_CACHE = `${SCOPE_CACHE_PREFIX}shell-v2.19.116-R1B-nav-diagnostic-r1`;
const RUNTIME_CACHE = `${SCOPE_CACHE_PREFIX}runtime-v2.19.116-R1B-nav-diagnostic-r1`;
...
async function loadOfflineManifest() {
  ...
  if(m.schema!==OFFLINE_MANIFEST_SCHEMA||m.app_version!=='v2.19.116-R1B-NAV-DIAGNOSTIC-R1'||m.storage_schema!==OFFLINE_STORAGE_SCHEMA)throw new Error('offline manifest incompatible');
