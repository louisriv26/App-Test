const VERSION = 'ldc-v2.19.84-R1B-stage8-r4';
...
const SHELL_CACHE = `${SCOPE_CACHE_PREFIX}shell-v2.19.84-R1B-stage8-r4`;
const RUNTIME_CACHE = `${SCOPE_CACHE_PREFIX}runtime-v2.19.84-R1B-stage8-r4`;
