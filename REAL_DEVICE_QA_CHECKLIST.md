...
Use only the exact **v101.137 R1** GitHub/device-test candidate whose SHA-256 is supplied in the external release receipt.
...
- Confirm `version.json` reports `app_version = v101.136`, `build_revision = R1`, and `cache_name = luisa-24h-v101-137-r1`.
